...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch-size", type=int,
                        help="Batch size of the parameter updates",
                        default=64)
    parser.add_argument("--n_epochs", type=int,
                        help="Number of epochs per rollout",
                        default=4)
    parser.add_argument("--clip-range-max", type=float,
                        help="Initial clip-range value",
                        default=0.2)
    parser.add_argument("--clip-range-min", type=float,
                        help="Minimum clip range value",
                        default=0.2)
