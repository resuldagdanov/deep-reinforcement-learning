...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="PPO with Box2d")
    ...
    parser.add_argument("--n-step", type=int, help="Length of the rollout", default=1024)
    ...
    parser.add_argument("--gae_lambda", type=float, help="lambda coefficient", default=0.98)
    ...
    parser.add_argument("--n_epochs", type=int, help="Number of epochs per rollout", default=4)
    ...
    parser.add_argument("--write-period", type=int, help="Logging period (interms of timesteps)", default=16 * 1024 * 5)
