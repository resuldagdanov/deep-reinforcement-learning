...
class ValueNet(torch.nn.Module):
    ...
    def __init__(self, in_size: int, out_size: int):
        ...
        # simple two layer network model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-iterations", type=int, default=160_000, help="Number of training iterations")
    parser.add_argument("--start-update", type=int, default=500, help="Number of iterations to wait before starting to update")
    ...
    parser.add_argument("--target-update-period", type=int, default=10, help="Target network update period")
    ...
    parser.add_argument("--epsilon-decay", type=float, default=0.995, help="Epsilon decay rate for exponential decaying")
    parser.add_argument("--epsilon-range", type=int, default=None, help="Epsilon decaying range for linear decay")
    parser.add_argument("--clip-grad", action="store_true", default=True, help="Gradient Clip between -1 and 1. Default: Yes")
    parser.add_argument("--eval-period", type=int, default=500, help="Evaluation period in terms of iteration")
    parser.add_argument("--eval-episode", type=int, default=5, help="Number of episodes to evaluate the policy at evaluation")
