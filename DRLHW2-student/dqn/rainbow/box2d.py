...
class ValueNet(torch.nn.Module):
    """
        Fully connected neural network to estimate Q values. Use NoisyLinear if noisy is True in the extensions. Final layer must be HeadLayer.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--noisy-std", type=float, default=0.5, help="Initial std for noisy layers")
    ...
    parser.add_argument("--vmin", type=float, default=-50, help="Minimum value for distributional DQN extension")
    parser.add_argument("--vmax", type=float, default=50, help="Maximum value for distributional DQN extension")
    ...
    parser.add_argument("--eval-episode", type=int, default=5, help="Number of episodes to evaluate")
