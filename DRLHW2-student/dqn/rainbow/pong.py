...
class ValueNet(torch.nn.Module):
    """ Convolutional neural network to estimate Q values. Use NoisyLinear 
    instead of Linear ones if noisy is True in the extensions. Final 
    layer must be HeadLayer.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-iterations", type=int, default=1500000,
                        help="Number of training iterations")
    parser.add_argument("--start-update", type=int, default=25000,
    ...
    parser.add_argument("--device", type=str, default="cpu",
                        help="Torch device")
    parser.add_argument("--target-update-period", type=int, default=2500,
                        help="Target network updating period")
    parser.add_argument("--buffer-capacity", type=int, default=250000,
    ...
    parser.add_argument("--epsilon-range", type=int, default=750000,
    ...
    parser.add_argument("--noisy-std", type=float, default=0.2,
    ...
    parser.add_argument("--vmin", type=float, default=-21,
                        help="Minimum value for distributional DQN extension")
    parser.add_argument("--vmax", type=float, default=21,
    ...
    # ----------------------- Miscelenious -----------------------
    parser.add_argument("--eval-period", type=int, default=25000,
    ...
    parser.add_argument("--write-period", type=int, default=2500,
                        help="Writer period")
